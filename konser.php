<?php 
   ...
   $result=mysqli_query($koneksi, "SELECT *FROM konser");
   	...
   	<div class="row header-content">
        ...
        <ul class="main-navigation sf-menu">
          <li><a href="index.html" title="">Home</a></li>
               ...
               <li class="current"><a href="konser.php" title="">Concerts</a></li>
   	...
   	<div class="row">
   		<div class="col-twelve">
   			...
   			<section>  
						...
						<h1 class="entry-title add-bottom">TOUR and CONCERT</h1> 

						<table border="1px">
						<tr align="center" style="background-color: #F5F5DC">
							<td>No</td>
							<td width="300px">Concerts</td>
							<td>Date</td>
							<td>Countries</td>	
						</tr>
